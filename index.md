...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td width="85%" valign="middle">
              ...
              <p>
              History showed that iPhone, 5G, and $$$$ didn't eliminate ICTD. Similarly, AlphaGo, GPT-4, and the like won't ever render AI for Nonprofits obsolete. In fact, it's one of the few areas in AI where academia is not fighting a losing battle.
              </p>
              <p>
